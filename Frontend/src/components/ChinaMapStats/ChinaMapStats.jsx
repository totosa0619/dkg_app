...
const ChinaMapStats = ({ data }) => {
  ...
  return (
    <Box className={classNameMain.container} style={{ backgroundColor: "white"}}>
      ...
      <Box className={classNameMain.mainContainer}>
        <Grid
          ...
          // alignItems="stretch"
        >
          <Grid item xs={12} md={3.6} className={classNameMain.mainSubSection}>
