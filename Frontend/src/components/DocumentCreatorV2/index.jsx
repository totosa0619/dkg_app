...
const DocumentCreatorIftameV2 = (props) => {
  const { data } = props;
  ...
  useEffect(() => {
    ...
    window.onmessage = function (e) {
      ...
      if (e.data.type === "isHeaderHide") {
        const data = {
          ...props.data,
          originalData: {
            ...props.data.originalData,
            isHeaderHide: e.data.isHeaderHide,
          },
        };
  ...
  return (
    <iframe
      ...
      src={`${CREATE_ROUTE}:diagramType/DocumentCreatorV2Edit`}
    />
  );
};

export default DocumentCreatorIftameV2;
