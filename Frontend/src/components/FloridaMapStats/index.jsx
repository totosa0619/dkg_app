...
import FloridaMapTopo from "./FloridaMapTopo";
...
const FloridaMapStats = ({ data }) => {
  const className = useStyles();
  const [selectedCountry, setSelectedCountry] = useState("Walton");
...
export default FloridaMapStats;
