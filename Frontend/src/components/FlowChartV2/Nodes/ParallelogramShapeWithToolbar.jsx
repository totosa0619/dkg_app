...
function ParallelogramShapeWithToolbar({ id, data, selected, isEditMode }) {
  const onChange = (_evt) => {
    data.handleEdit(id);
  };
      ...
      >
        <svg width={width} height={height} className="shape-svg">
          <g transform={`translate(2, 2)`}>
            <path
              d={`M0,${effectiveHeight} L${effectiveWidth * 0.24286},0 L${
                effectiveWidth * 0.97143
              },0 L${effectiveWidth * 0.72857},${effectiveHeight} Z`}
...
export default ParallelogramShapeWithToolbar;
