...
const MacroPanel = (props) => {
  ...
  const mainNameFontSize = data?.mainNameFontSize;
  const mainNameLineHeight = data?.mainNameLineHeight;
        ...
        {mainNameforPage && (
          ...
          >
            <div
              style={{
                fontWeight: 600,
                fontSize: mainNameFontSize ? mainNameFontSize : "26px",
                textAlign: "center",
                lineHeight: mainNameLineHeight ? mainNameLineHeight : "30px",
              }}
            >
              {mainNameforPage}
            </div>
