...
import IsraelMapTopo from "./IsraelMapTopo";
...
const IsraelMapStats = ({ data }) => {
  const className = useStyles();
  const [selectedCountry, setSelectedCountry] = useState("Central");
