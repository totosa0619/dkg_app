...
const CustomPoint = ({
  ...
  hoverArea,
  name,
  fontSizeDescriptionFull,
  descriptionHeightFull,
}) => {
  ...
  return geoData?.logos?.length || geoData?.description ? (
    ...
    >
      ...
      <foreignObject width={200} height={descriptionHeightFull} y={250} x={160}>
        <div
          style={{
            width: "100%",
            height: "100%",
        ...
        >
          <span className={classes.contentBox}>
            <span style={{ marginBottom: "3px", fontSize: "7px" }}></span>
            ...
            <span
              style={{
                fontSize: fontSizeDescriptionFull,
              }}
            >
              {geoData.description}
            </span>
