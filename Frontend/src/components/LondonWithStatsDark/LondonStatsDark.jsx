    ...
    <Box className={classNameMain.container} style={{ backgroundColor: "#171d32"}}>
      ...
      <Box className={classNameMain.mainContainer}>
        <Grid
          ...
          alignItems="stretch"
        >
          <Grid item xs={12} md={3.9} className={classNameMain.mainSubSection} backgroundColor="#283046">
          ...
          >
            <Grid item xs={12} className={classNameMain.mainSubSection_3} backgroundColor="#283046">
...
export default LondonStatsDark;
