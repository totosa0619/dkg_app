...
const NorthIrelandMapStats = ({ data }) => {
  const className = useStyles();
  const [selectedCountry, setSelectedCountry] = useState("Foyle");
  ...
  return (
    <Box className={className.container}>
      ...
      <Box className={className.mainContainer} backgroundColor="white">
        <Grid
          style={{ width: "100%" }}
...
export default NorthIrelandMapStats;
