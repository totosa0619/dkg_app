...
import ScotlandMapTopo from "../ScotlandMapTopo";
...
const ScotlandMapStats = ({ data }) => {
  const className = useStyles();
  const [selectedCountry, setSelectedCountry] = useState("Clackmannanshire");
...
export default ScotlandMapStats;
