...
export default function TreeNoDateDesigner(props) {
  const dataProps = props?.data.originalData.data;
  const zoomLevel = props?.data.originalData.zoomLevel;
  const links = props?.data.originalData.links;
