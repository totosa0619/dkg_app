...
import TOPO_JSON from "/assets/topojson/WalesMapTopo.json?url";
  ...
  return (
    <>
      ...
      <ComposableMap
        ...
        projectionConfig={{
          rotate: [3.9, props?.mapTitle ? -52.5 : -52.1307, 0],
          scale: props?.mapTitle ? 45000 : 24000,
        }}
      >
